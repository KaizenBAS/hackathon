      ...
      <>
        ...
        <div className="w-screen h-[682px] flex items-center justify-center">
          ...
          <div className="flex flex-col gap-5 p-5  w-[510px] h-[432px] ">
            ...
            <div className="flex  gap-5">
              <button className="w=[184px] h-[52px] bg-[#2DC071] py-1 px-5 rounded-md">
                BUY NOW
              </button>
              <button className="w=[184px] h-[52px] bg-[transparent] text-[#2DC071] font-bold border -1px border-[#2DC071] py-1 px-5 rounded-md">
                READ MORE
              </button>
            </div>
          </div>
        ...
        <div className="w-screen h-[1044px] flex flex-col items-center ">
          <div className="text-center flex gap-5 flex-col py-20 w-[691px] h-[134px] mb-20">
            ...
            <h1 className="text-[#252B42] text-5xl font-bold">
              Featured Posts
            </h1>
            ...
            {/* cards section */}
    <div className="w-full mt-20 flex flex-wrap gap-3 justify-center">
  {/* Card 1 */}
  <div className="w-full sm:w-[328px] h-[606px] bg-white flex flex-col mb-5">
    <div>
      <Image
        src="/splash1.png"
        alt="social"
    ...
    <div className="flex gap-5 p-2 justify-between">
      <div className="flex gap-2 items-center">
        ...
        />
        <p className="text-[#737373]">22 April 2022</p>
      </div>
      <div className="flex gap-2 items-center">
        <Image
          src="/galleryicon.png"
