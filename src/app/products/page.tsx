...
export default function Products() {
  return (
    <div className="bg-[#FFFFFF]">
      ...
      <div className="w-screen  flex gap-5  justify-center items-center relative  flex-wrap  md:flex-row flex-col ">
      ...
      <div className="w-screen h-[98px]   flex items-center justify-around">
        <div>
          <h3 className=" text-[#BDBDBD] font-bold">Showing all 13 results</h3>
        </div>
